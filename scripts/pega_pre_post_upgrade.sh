# script for pre-post upgrade actions. The default implementation does nothing. It can be overidden in the script pre_post_upgrade_utils.sh available in distribution kit.
